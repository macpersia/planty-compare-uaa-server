package be.planty.compare.uaa.server.config;
...
@Configuration
@EnableMongoRepositories("be.planty.compare.uaa.server.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("be.planty.compare.uaa.server.config.dbmigrations");
