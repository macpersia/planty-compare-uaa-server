package be.planty.compare.uaa.server.repository;

import be.planty.compare.uaa.server.PlantyCompareUaaServerApp;
import be.planty.compare.uaa.server.config.Constants;
import be.planty.compare.uaa.server.config.audit.AuditEventConverter;
import be.planty.compare.uaa.server.domain.PersistentAuditEvent;
...
import static be.planty.compare.uaa.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
